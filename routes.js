...
const { register,login, getuser ,updateuser,getotp,verifyotp,resetpass, resetSession,verifyuser,pregister,pdata, dlt, updt} = require('./function')
...
router.route('/update/:id').put(updt)

router.route('/delete/:id').delete(dlt);
